...
public class RegisterForm extends AppCompatActivity {
        ...
        btnReg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if( tmobile.matches("")){
                    ...
                    Toast.makeText(RegisterForm.this,"Write Address line 1",Toast.LENGTH_SHORT).show();
                }
                else if(tadd2.matches("")){
                    Toast.makeText(RegisterForm.this,"Write Address line 2",Toast.LENGTH_SHORT).show();
                }
                else if(tpin.matches("")){
                    Toast.makeText(RegisterForm.this,"Write Pincode",Toast.LENGTH_SHORT).show();
                }
                else if(tpin.length() != 6){
                    Toast.makeText(RegisterForm.this,"Enter Proper Pincode",Toast.LENGTH_SHORT).show();
                }
                else if(tmobile.length() != 10){
                    Toast.makeText(RegisterForm.this,"Enter Proper Mobile no",Toast.LENGTH_SHORT).show();
                }
    ...
    public void sendData() {
        ...
        mRef.setValue(add1);
        //Toast.makeText(RegisterForm.this,"Sending "+add1,Toast.LENGTH_SHORT).show();
        mRef = mData.getReference().child("users").child(userKey).child("address2");
        mRef.setValue(add2);
        //Toast.makeText(RegisterForm.this,"Sending "+add2,Toast.LENGTH_SHORT).show();
        mRef = mData.getReference().child("users").child(userKey).child("email");
        mRef.setValue(userEmail);
        //Toast.makeText(RegisterForm.this,"Sending "+userEmail,Toast.LENGTH_SHORT).show();
        ...
        mRef.setValue(pin);
        //Toast.makeText(RegisterForm.this,"Sending "+pin,Toast.LENGTH_SHORT).show();
        finish();
    }

    @Override
    public void onBackPressed() {
        AuthUI.getInstance().signOut(RegisterForm.this);
        super.onBackPressed();
    }
